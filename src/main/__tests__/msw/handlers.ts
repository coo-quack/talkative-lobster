...
export const handlers = [
  ...
  http.post('https://api.elevenlabs.io/v1/speech-to-text', () =>
    HttpResponse.json({
      ...
      text: 'こんにちは',
      words: [{ text: 'こんにちは', start: 0.0, end: 1.0, type: 'word', logprob: -0.1 }]
    })
  ),

  // ElevenLabs TTS streaming (PCM S16LE format)
  http.post('https://api.elevenlabs.io/v1/text-to-speech/:voiceId/stream', () => {
    // Return raw PCM S16LE samples (16-bit signed little-endian)
